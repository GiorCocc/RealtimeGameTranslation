...
## 📌 Indice
- [Realtime Game Translation Overlay](#realtime-game-translation-overlay)
  - [📌 Indice](#-indice)
  - [📖 Panoramica e Contesto](#-panoramica-e-contesto)
  ...
  - [🚀 Installazione e Setup](#-installazione-e-setup)
    ...
    - [2. Configura l'ambiente virtuale](#2-configura-lambiente-virtuale)
    - [3. Installa le dipendenze](#3-installa-le-dipendenze)
  - [⚙️ Configurazione](#️-configurazione)
  - [🎮 Utilizzo e Quick Start](#-utilizzo-e-quick-start)
    - [Avvio dell'Applicazione Completa](#avvio-dellapplicazione-completa)
    - [Comandi per i Test di Fase (Debugging)](#comandi-per-i-test-di-fase-debugging)
...
<img width="3144" height="1760" alt="Scan_20260705_162643" src="https://github.com/user-attachments/assets/124beb7a-9d30-44b5-8c57-f687a503da29" />
